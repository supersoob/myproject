...
# Direct port of the hificode_Opencv2.c C program minus built-in image
# Last update: September 14, 2018; released under the Creative
...
# while the PyPy python JIT compiler does not (yet) support Opencv2

from cv2 import cv2
import os, sys, struct, math

import winsound    # Sound output for Microsoft Windows
#import subprocess  # Used in sound output for Linux
...
CAM      =     1   # Use Opencv2 camera input No|Yes=0|1
...
def main():
   ...
   cam_id = 0  # First available Opencv2 camera
   # Optionally override ID from command line parameter: python hificode_Opencv2.py cam_id
   ...
   #   cv2.namedWindow('Large', cv2.WINDOW_AUTOSIZE)
   ...
   print("hificode.wav")  # Play the soundscape
